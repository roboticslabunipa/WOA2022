...
public abstract class Literal extends DefaultTerm implements LogicalFormula {
    ...
    // ---- NEW ----
    /**
     * Return the literal without variable grounded
     * @return new structure with all argument not grounded
     */
    public String notGrounded(){
        logger.log(Level.SEVERE, "notGrounded is not implemented in the class "+this.getClass().getSimpleName(), new Exception());
        return null;
    }
    // ---- END ----
