...
public class Structure extends Atom {
    ...
    */
    ...
    /* TODO: controllare se il principio di funzionamento è lo stesso di makeTermAnnon e in caso utilizzare quest'ultima */
    @Override
        ...
        if(!s.isAtom()){
            ...
            for(Term t : s.getTerms()){
                if(t.isGround()){
                    ...
                    //logger.info("Trasform "+t.toString()+" in "+var);
                    s.setTerm(i, var);
                }
                ++i;    
            }
